...
{ 
    public class SprintController : Controller
    {
        ...
        {
            List<DateTime> sd = sprintR.GetAllSprintStartDatesByProject(sprint.ProjectId.Value).ToList<DateTime>();
            List<DateTime> ed = sprintR.GetAllSprintEndDatesByProject(sprint.ProjectId.Value).ToList<DateTime>();
